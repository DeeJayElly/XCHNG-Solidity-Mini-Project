(function () {
          ...
          is_object: function (val) {
            ...
            return logs.map(function (log) {
              ...
              function partialABI(fullABI, indexed) {
                ...
                var partial = {inputs: inputs, name: fullABI.name, type: fullABI.type, anonymous: fullABI.anonymous};
                return partial
              }
                      ...
                      C.web3.eth.getTransactionReceipt(tx, function (err, receipt) {
                        ...
                        if (receipt != null) {
                          if (parseInt(receipt.status, 16) == 0) {
                            ...
                            return accept({tx: tx, receipt: receipt, logs: Utils.decodeLogs(C, instance, receipt.logs)})
                          }
                        }
  ...
  4: [function (require, module, exports) {
    "use strict";
    var compileSchema = require("./compile"), resolve = require("./compile/resolve"), Cache = require("./cache"),
      SchemaObject = require("./compile/schema_obj"), stableStringify = require("fast-json-stable-stringify"),
      formats = require("./compile/formats"), rules = require("./compile/rules"), $dataMetaSchema = require("./$data"),
      patternGroups = require("./patternGroups"), util = require("./compile/util"), co = require("co");
    module.exports = Ajv;
    ...
    function _addSchema(schema, skipValidation, meta, shouldAddSchema) {
      ...
      var schemaObj = new SchemaObject({id: id, schema: schema, localRefs: localRefs, cacheKey: cacheKey, meta: meta});
  ...
  10: [function (require, module, exports) {
    "use strict";
    var resolve = require("./resolve"), util = require("./util"), errorClasses = require("./error_classes"),
    ...
    function compile(schema, root, localRefs, baseId) {
      var self = this, opts = this._opts, refVal = [undefined], refs = {}, patterns = [], patternsHash = {},
  ...
  11: [function (require, module, exports) {
    "use strict";
    var url = require("url"), equal = require("fast-deep-equal"), util = require("./util"),
      SchemaObject = require("./schema_obj"), traverse = require("json-schema-traverse");
    ...
    module.exports = function rules() {
      ...
      RULES.forEach(function (group) {
        group.rules = group.rules.map(function (keyword) {
          ...
          ALL.push(keyword);
          var rule = RULES.all[keyword] = {keyword: keyword, code: ruleModules[keyword], implements: implKeywords};
          return rule
        });
  ...
  15: [function (require, module, exports) {
    ...
    function checkDataType(dataType, data, negate) {
      var EQUAL = negate ? " !== " : " === ", AND = negate ? " || " : " && ", OK = negate ? "!" : "",
        NOT = negate ? "" : "!";
      switch (dataType) {
        case"null":
    ...
    var EMPTY_ELSE = /else\s*{\s*}/g, EMPTY_IF_NO_ELSE = /if\s*\([^)]+\)\s*\{\s*\}(?!\s*else)/g,
    ...
    var ERRORS_REGEXP = /[^v.]errors/g,
      ...
      REMOVE_ERRORS_ASYNC = /var errors = 0;|var vErrors = null;/g, RETURN_VALID = "return errors === 0;",
      RETURN_TRUE = "validate.errors = null; return true;",
      RETURN_ASYNC = /if \(errors === 0\) return data;\s*else throw new ValidationError\(vErrors\);/,
      RETURN_DATA_ASYNC = "return data;", ROOTDATA_REGEXP = /[^A-Za-z_$]rootData[^A-Za-z0-9_$]/g,
  ...
  16: [function (require, module, exports) {
    ...
    module.exports = function generate__limit(it, $keyword, $ruleType) {
      ...
      var $isMax = $keyword == "maximum", $exclusiveKeyword = $isMax ? "exclusiveMaximum" : "exclusiveMinimum",
        $schemaExcl = it.schema[$exclusiveKeyword], $isDataExcl = it.opts.$data && $schemaExcl && $schemaExcl.$data,
        $op = $isMax ? "<" : ">", $notOp = $isMax ? ">" : "<", $errorKeyword = undefined;
      if ($isDataExcl) {
        var $schemaValueExcl = it.util.getData($schemaExcl.$data, $dataLvl, it.dataPathArr),
          $exclusive = "exclusive" + $lvl, $exclType = "exclType" + $lvl, $exclIsNumber = "exclIsNumber" + $lvl,
          $opExpr = "op" + $lvl, $opStr = "' + " + $opExpr + " + '";
  ...
  23: [function (require, module, exports) {
    ...
    module.exports = function generate_contains(it, $keyword, $ruleType) {
      ...
      $it.level++;
      var $nextValid = "valid" + $it.level;
      var $idx = "i" + $lvl, $dataNxt = $it.dataLevel = it.dataLevel + 1, $nextData = "data" + $dataNxt,
        $currentBaseId = it.baseId, $nonEmptySchema = it.util.schemaHasRules($schema, it.RULES.all);
  ...
  24: [function (require, module, exports) {
    ...
    module.exports = function generate_custom(it, $keyword, $ruleType) {
      ...
      var $ruleErrs = $validateCode + ".errors", $i = "i" + $lvl, $ruleErr = "ruleErr" + $lvl,
          ...
          if ($breakOnError) {
            ...
            if (arr2) {
              ...
              while (i2 < l2) {
                ...
                var $prop = it.util.getProperty($propertyKey), $missingProperty = it.util.escapeQuotes($propertyKey),
                  $useData = $data + $prop;
                if (it.opts._errorDataPathProperty) {
  ...
  33: [function (require, module, exports) {
    ...
    module.exports = function generate_properties(it, $keyword, $ruleType) {
      ...
      $it.level++;
      var $nextValid = "valid" + $it.level;
      var $key = "key" + $lvl, $idx = "idx" + $lvl, $dataNxt = $it.dataLevel = it.dataLevel + 1,
        $nextData = "data" + $dataNxt, $dataProperties = "dataProperties" + $lvl;
      var $schemaKeys = Object.keys($schema || {}), $pProperties = it.schema.patternProperties || {},
        $pPropertyKeys = Object.keys($pProperties), $aProperties = it.schema.additionalProperties,
        $someProperties = $schemaKeys.length || $pPropertyKeys.length, $noAdditional = $aProperties === false,
        $additionalIsSchema = typeof $aProperties == "object" && Object.keys($aProperties).length,
        $removeAdditional = it.opts.removeAdditional,
        $checkAdditional = $noAdditional || $additionalIsSchema || $removeAdditional,
        $ownProperties = it.opts.ownProperties, $currentBaseId = it.baseId;
      ...
      if ($schemaKeys.length) {
        ...
        if (arr4) {
          ...
          while (i4 < l4) {
            ...
            if (it.util.schemaHasRules($sch, it.RULES.all)) {
              var $prop = it.util.getProperty($propertyKey), $passData = $data + $prop,
              ...
              if ($hasDefault) {
                ...
                if ($requiredHash && $requiredHash[$propertyKey]) {
                  ...
                  out += ") { " + $nextValid + " = false; ";
                  var $currentErrorPath = it.errorPath, $currErrSchemaPath = $errSchemaPath,
  ...
  34: [function (require, module, exports) {
    ...
    module.exports = function generate_propertyNames(it, $keyword, $ruleType) {
      ...
      if (it.util.schemaHasRules($schema, it.RULES.all)) {
        ...
        $it.schemaPath = $schemaPath;
        $it.errSchemaPath = $errSchemaPath;
        var $key = "key" + $lvl, $idx = "idx" + $lvl, $i = "i" + $lvl, $invalidName = "' + " + $key + " + '",
          $dataNxt = $it.dataLevel = it.dataLevel + 1, $nextData = "data" + $dataNxt,
          $dataProperties = "dataProperties" + $lvl, $ownProperties = it.opts.ownProperties, $currentBaseId = it.baseId;
        out += " var " + $errs + " = errors; ";
        if ($ownProperties) {
          out += " var " + $dataProperties + " = undefined; "
        }
  ...
  36: [function (require, module, exports) {
    ...
    module.exports = function generate_required(it, $keyword, $ruleType) {
      ...
      if ($isData || $required.length) {
        var $currentErrorPath = it.errorPath, $loopRequired = $isData || $required.length >= it.opts.loopRequired,
        ...
        if ($breakOnError) {
          ...
          if ($loopRequired) {
            ...
            var $i = "i" + $lvl, $propertyPath = "schema" + $lvl + "[" + $i + "]",
  ...
  38: [function (require, module, exports) {
    ...
    module.exports = function generate_validate(it, $keyword, $ruleType) {
      ...
      var $async = it.schema.$async === true,
        $refKeywords = it.util.schemaHasRulesExcept(it.schema, it.RULES.all, "$ref"), $id = it.self._getId(it.schema);
      if (it.isTop) {
        if ($async) {
          it.async = true;
  ...
  63: [function (require, module, exports) {
    var Blockchain = {
      getBlockByNumber: function (blockNumber, provider, callback) {
        ...
        provider.sendAsync({jsonrpc: "2.0", method: "eth_getBlockByNumber", params: params, id: Date.now()}, callback)
      }, getBlockByHash: function (blockHash, provider, callback) {
        var params = [blockHash, true];
        provider.sendAsync({jsonrpc: "2.0", method: "eth_getBlockByHash", params: params, id: Date.now()}, callback)
      }, parse: function (uri) {
        var parsed = {};
  ...
  74: [function (require, module, exports) {
    ...
    var protocolPattern = /^([a-z0-9.+-]+:)/i, portPattern = /:[0-9]*$/,
      ...
      hostnamePartStart = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, unsafeProtocol = {javascript: true, "javascript:": true},
